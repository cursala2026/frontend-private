...
- Name: remove-correct-option.spec.ts >> Eliminación de opciones en editor de cuestionario >> eliminar una opción del medio deja el orden correcto
- Location: e2e\remove-correct-option.spec.ts:190:7

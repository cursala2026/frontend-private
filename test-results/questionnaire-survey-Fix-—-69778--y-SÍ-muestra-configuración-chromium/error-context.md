...
- Name: questionnaire-survey.spec.ts >> Fix — Encuestas no muestran configuración de evaluación >> Card de cuestionario normal NO muestra badge de encuesta y SÍ muestra configuración
- Location: e2e\questionnaire-survey.spec.ts:84:7
...
Call log:
  - waiting for locator('text=Examen Final') to be visible

...
- Name: questionnaire-survey.spec.ts >> Fix — Encuestas no muestran configuración de evaluación >> Formulario de edición muestra sección Configuración al desmarcar isSurvey
- Location: e2e\questionnaire-survey.spec.ts:108:7

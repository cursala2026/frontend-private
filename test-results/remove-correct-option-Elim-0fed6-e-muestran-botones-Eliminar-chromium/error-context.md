...
- Name: remove-correct-option.spec.ts >> Eliminación de opciones en editor de cuestionario >> con cuestionario que tiene envíos, no se muestran botones Eliminar
- Location: e2e\remove-correct-option.spec.ts:246:7

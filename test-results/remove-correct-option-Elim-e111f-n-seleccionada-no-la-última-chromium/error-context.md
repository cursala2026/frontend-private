...
- Name: remove-correct-option.spec.ts >> Eliminación de opciones en editor de cuestionario >> eliminar la opción correcta elimina la opción seleccionada, no la última
- Location: e2e\remove-correct-option.spec.ts:113:7

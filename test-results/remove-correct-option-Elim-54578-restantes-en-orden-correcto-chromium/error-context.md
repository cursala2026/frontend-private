...
- Name: remove-correct-option.spec.ts >> Eliminación de opciones en editor de cuestionario >> eliminar la primera opción deja las 3 restantes en orden correcto
- Location: e2e\remove-correct-option.spec.ts:148:7

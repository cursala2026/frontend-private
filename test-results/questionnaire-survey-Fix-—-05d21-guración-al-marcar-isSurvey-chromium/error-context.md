...
- Name: questionnaire-survey.spec.ts >> Fix — Encuestas no muestran configuración de evaluación >> Formulario de edición oculta sección Configuración al marcar isSurvey
- Location: e2e\questionnaire-survey.spec.ts:97:7

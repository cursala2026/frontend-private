...
- Name: auth-flow.spec.ts >> Autenticación y LocalStorage >> debe cerrar sesión automáticamente ante un error 401 del backend
- Location: e2e\auth-flow.spec.ts:70:7
...
Received string:  "http://localhost:4200/alumno"
Timeout: 15000ms

Call log:
  - Expect "toHaveURL" with timeout 15000ms
    33 × unexpected value "http://localhost:4200/alumno"
...
- navigation:
  ...
  - link "Mis Certificados":
    - /url: /alumno/certificates
  - button:
    - img
- main:
  - heading [level=1]
  - paragraph: Explora nuestros cursos disponibles y comienza tu aprendizaje
  - img
  - term: Cursos Inscritos
  - definition
  - img
  - term: Cursos Completados
  - definition
  - img
  - term: Promedio General
  - definition
  - heading "Cursos Disponibles" [level=2]
```

...
- Name: remove-correct-option.spec.ts >> Eliminación de opciones en editor de cuestionario >> eliminar la última opción deja las 3 primeras en orden correcto
- Location: e2e\remove-correct-option.spec.ts:169:7
